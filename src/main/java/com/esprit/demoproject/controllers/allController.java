...
public class allController {
    ...
    @GetMapping("libelleMenu")
    public List<String> listLib(@RequestBody String typeMenu){
    return interfaces.libelleMenuParTypeMenuordonneParPrixTotal(TypeMenu.valueOf(typeMenu));
    }
